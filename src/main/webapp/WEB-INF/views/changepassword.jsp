					...
					<form class="form-horizontal"  action="changepassword" method="post" onsubmit="return validate();">
						...
						<div class="">
	                        <div class="col-xs-12 p">
	                        	<div class="input-group">
									...
									<input type="password" class="form-control" id="password1" placeholder="Confirm password" name="password">
								</div>
	                        </div>
						</div>
						...
						<div class="">
							<div class="button-login">	
								...
								<button type="submit" class="btn btn-primary" formmethod="get" formaction="dashboard">Close</button>
